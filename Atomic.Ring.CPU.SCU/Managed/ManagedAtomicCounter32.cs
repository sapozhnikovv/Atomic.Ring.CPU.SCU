...
/// </summary>
public sealed class ManagedAtomicCounter32: ManagedAtomicCounterBase
{
    ...
    public ManagedAtomicCounter32(byte expansionFactor = 0) : base(expansionFactor)
    {
    ...
    /// <exception cref="ArgumentException">when <paramref name="expansionFactor"/> more than 8 or when <paramref name="ringLength"/> ≤ 2</exception>
    public ManagedAtomicCounter32(uint ringLength, byte expansionFactor) : base(ringLength, expansionFactor)
    {
        _ring = new PaddedCounter[_ringLength];
    }
