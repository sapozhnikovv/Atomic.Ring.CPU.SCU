...
/// </summary>
public sealed class ManagedAtomicCounter128 : ManagedAtomicCounterBase
{
    ...
    public ManagedAtomicCounter128(byte expansionFactor = 0) : base(expansionFactor)
    {
    ...
    /// <exception cref="ArgumentException">when <paramref name="expansionFactor"/> more than 8 or when <paramref name="ringLength"/> ≤ 2</exception>
    public ManagedAtomicCounter128(uint ringLength, byte expansionFactor) : base(ringLength, expansionFactor)
    {
        _ring = new PaddedCounter[_ringLength];
    }
